...
class InsuranceAppSettings(AppSettings):
    app_insurance_client_repository: Optional[str] = ""
    app_insurance_claim_repository: Optional[str] = ""
    app_insurance_backend_url: Optional[str] = ""
    ...
    if _config is None:
        ...
        if CONFIG_FILE:
            ...
            with open(CONFIG_FILE, 'r') as file:
                _config = parse_yaml_raw_as(InsuranceAppSettings,file.read())
        else:
            _config = InsuranceAppSettings()
