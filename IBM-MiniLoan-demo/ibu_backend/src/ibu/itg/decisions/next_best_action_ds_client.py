...
from ibu.itg.ds.loanapp_client_repo_mock import LoanAppRepositoryInMem
from ibu.itg.ds.pydantic_generated_model import *
...
def _get_borrower_data(config, first_name: str, last_name: str):
    borrower_repository= LoanAppRepositoryInMem.initialize_client_db()
